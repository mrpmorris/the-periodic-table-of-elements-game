	...
	byte? HighlightedAtomicNumber)
{
	...
	public ElementsSpeedMatchGameState() : this(
		HighlightedAtomicNumber: null,
		...
		ElementTimings: new ReadOnlyDictionary<int, object>(
			new Dictionary<int, object>
			{
				...
				[015_920] = new HighlightElementAction(095), // Am
				[016_500] = new HighlightElementAction(044), // Ru
				...
				[033_350] = new HighlightElementAction(038), // Sr
				[033_838] = new HighlightElementAction(014), // Si
				[034_394] = new HighlightElementAction(047), // Ag
				[034_925] = new HighlightElementAction(062), // Sm
				...
				[056_640] = new HighlightElementAction(067), // Ho
				[057_200] = new HighlightElementAction(002), // He
				[057_650] = new HighlightElementAction(072), // Hf
				[058_130] = new HighlightElementAction(068), // Er
				[058_700] = new HighlightElementAction(015), // P
				[059_250] = new HighlightElementAction(087), // Fr
				[059_750] = new HighlightElementAction(009), // F
				[060_250] = new HighlightElementAction(065), // Tb
				[060_790] = new HighlightElementAction(025), // Mn
				[061_300] = new HighlightElementAction(080), // Hg
				[061_800] = new HighlightElementAction(042), // Mo
				[062_315] = new HighlightElementAction(012), // Mg
				[062_860] = new HighlightElementAction(066), // Dy
