...
namespace ThePeriodicTableOfElementsGame.GamePlay.PeriodicTableData
{
	public static class TableOfElementsData
	{
		...
		private static ReadOnlyDictionary<int, ElementData> CreateElements()
		{
			...
			{
				[001] = new ElementData(001, "H", "Hydrogen", 1, 1, ElementGroup.ReactiveNonmetal),
				...
				[004] = new ElementData(004, "Be", "Beryllium", 2, 2, ElementGroup.AlkalineEarthMetal),
				[005] = new ElementData(005, "B", "Boron", 13, 2, ElementGroup.Metalloid),
				[006] = new ElementData(006, "C", "Carbon", 14, 2, ElementGroup.ReactiveNonmetal),
				[007] = new ElementData(007, "N", "Nitrogen", 15, 2, ElementGroup.ReactiveNonmetal),
				[008] = new ElementData(008, "O", "Oxygen", 16, 2, ElementGroup.ReactiveNonmetal),
				[009] = new ElementData(009, "F", "Fluorine", 17, 2, ElementGroup.ReactiveNonmetal),
				...
				[013] = new ElementData(013, "Al", "Aluminium", 13, 3, ElementGroup.PostTransitionMetal),
				[014] = new ElementData(014, "Si", "Silicon", 14, 3, ElementGroup.Metalloid),
				[015] = new ElementData(015, "P", "Phosphorus", 15, 3, ElementGroup.ReactiveNonmetal),
				[016] = new ElementData(016, "S", "Sulfur", 16, 3, ElementGroup.ReactiveNonmetal),
				[017] = new ElementData(017, "Cl", "Chlorine", 17, 3, ElementGroup.ReactiveNonmetal),
				...
				[030] = new ElementData(030, "Zn", "Zinc", 12, 4, ElementGroup.PostTransitionMetal),
				[031] = new ElementData(031, "Ga", "Gallium", 13, 4, ElementGroup.PostTransitionMetal),
				[032] = new ElementData(032, "Ge", "Germanium", 14, 4, ElementGroup.Metalloid),
				[033] = new ElementData(033, "As", "Arsenic", 15, 4, ElementGroup.Metalloid),
				[034] = new ElementData(034, "Se", "Selenium", 16, 4, ElementGroup.ReactiveNonmetal),
				[035] = new ElementData(035, "Br", "Bromine", 17, 4, ElementGroup.ReactiveNonmetal),
				...
				[048] = new ElementData(048, "Cd", "Cadmium", 12, 5, ElementGroup.PostTransitionMetal),
				[049] = new ElementData(049, "In", "Indium", 13, 5, ElementGroup.PostTransitionMetal),
				[050] = new ElementData(050, "Sn", "Tin", 14, 5, ElementGroup.PostTransitionMetal),
				[051] = new ElementData(051, "Sb", "Antimony", 15, 5, ElementGroup.Metalloid),
				[052] = new ElementData(052, "Te", "Tellurium", 16, 5, ElementGroup.Metalloid),
				[053] = new ElementData(053, "I", "Iodine", 17, 5, ElementGroup.ReactiveNonmetal),
				...
				[080] = new ElementData(080, "Hg", "Mercury", 12, 6, ElementGroup.PostTransitionMetal),
				[081] = new ElementData(081, "Tl", "Thallium", 13, 6, ElementGroup.PostTransitionMetal),
				[082] = new ElementData(082, "Pb", "Lead", 14, 6, ElementGroup.PostTransitionMetal),
				[083] = new ElementData(083, "Bi", "Bismuth", 15, 6, ElementGroup.PostTransitionMetal),
				[084] = new ElementData(084, "Po", "Polonium", 16, 6, ElementGroup.PostTransitionMetal),
				[085] = new ElementData(085, "At", "Astatine", 17, 6, ElementGroup.Metalloid),
				...
				[089] = new ElementData(089, "Ac", "Actinium", 3, 9.25m, ElementGroup.Actinide),
				[090] = new ElementData(090, "Th", "Thorium", 4, 9.25m, ElementGroup.Actinide),
				[091] = new ElementData(091, "Pa", "Protactinium", 5, 9.25m, ElementGroup.Actinide),
				[092] = new ElementData(092, "U", "Uranium", 6, 9.25m, ElementGroup.Actinide),
				[093] = new ElementData(093, "Np", "Neptunium", 7, 9.25m, ElementGroup.Actinide),
				[094] = new ElementData(094, "Pu", "Plutonium", 8, 9.25m, ElementGroup.Actinide),
				[095] = new ElementData(095, "Am", "Americium", 9, 9.25m, ElementGroup.Actinide),
				[096] = new ElementData(096, "Cm", "Curium", 10, 9.25m, ElementGroup.Actinide),
				[097] = new ElementData(097, "Bk", "Berkelium", 11, 9.25m, ElementGroup.Actinide),
				[098] = new ElementData(098, "Cf", "Californium", 12, 9.25m, ElementGroup.Actinide),
				[099] = new ElementData(099, "Es", "Einsteinium", 13, 9.25m, ElementGroup.Actinide),
				[100] = new ElementData(100, "Fm", "Fermium", 14, 9.25m, ElementGroup.Actinide),
				[101] = new ElementData(101, "Md", "Mendelevium", 15, 9.25m, ElementGroup.Actinide),
				[102] = new ElementData(102, "No", "Nobelium", 16, 9.25m, ElementGroup.Actinide),
				[103] = new ElementData(103, "Lr", "Lawrencium", 17, 9.25m, ElementGroup.Actinide),
				#endregion
				...
				[109] = new ElementData(109, "Mt", "Meitnerium", 9, 7, ElementGroup.Unknown),
				[110] = new ElementData(110, "Ds", "Darmstadtium", 10, 7, ElementGroup.Unknown),
				[111] = new ElementData(111, "Rg", "Roentgenium", 11, 7, ElementGroup.Unknown),
				[112] = new ElementData(112, "Cn", "Copernicium", 12, 7, ElementGroup.PostTransitionMetal),
				[113] = new ElementData(113, "Nh", "Nihonium", 13, 7, ElementGroup.Unknown),
				[114] = new ElementData(114, "Fl", "Flerovium", 14, 7, ElementGroup.Unknown),
				[115] = new ElementData(115, "Mc", "Moscovium", 15, 7, ElementGroup.Unknown),
				[116] = new ElementData(116, "Lv", "Livermorium", 16, 7, ElementGroup.Unknown),
